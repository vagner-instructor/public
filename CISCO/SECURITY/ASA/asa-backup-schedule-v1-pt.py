...
# Objetivo:
# Fazer backup da configuração dos equipamentos ASAs
#
# Dependências:
## pip install netmiko
## pip install schedule
## Criar uma pasta para armazenar os backups, exemplo "C:\Filezilla\Backups\ASA\"
## Criar um arquivo com os ips dos ASAs na pasta com o nome "asa-backup-schedule-devices-pt"
#
...
def BACKUP():
    ...
    IP_LIST = open('asa-backup-schedule-devices-pt')
    for IP in IP_LIST:
        ASA = {
